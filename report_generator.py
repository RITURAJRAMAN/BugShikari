...
"""
    ...
    html += f"""
        <div class="footer">
            <p>Generated by <a href="https://github.com/RITURAJRAMAN/BugShikari" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none;"><strong>BugShikari</strong></a> — Advanced Bug Hunting Toolkit</p>
